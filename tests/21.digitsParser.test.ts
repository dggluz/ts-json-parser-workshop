import { digitsParser } from '../src';

describe.skip('digitsParser', () => {
  it('Parses "1234567890"', async () => {
    ...
    // WHEN:
    // Parsing the input with the digitsParser
    const { result, remaining } = await digitsParser(input);

    // THEN:
    // The result is the "1234567890" string
